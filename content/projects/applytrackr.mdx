...
gallery:
  - src: "/projects/screenshots/applytrackr-dashboard.png"
    alt: "ApplyTrackr dashboard using synthetic job application data"
    label: "Pipeline dashboard"
  - src: "/projects/screenshots/applytrackr-applications.png"
    alt: "ApplyTrackr applications table using fictional companies and roles"
    label: "Applications"
  - src: "/projects/screenshots/applytrackr-performance.png"
    alt: "ApplyTrackr resume and category performance insights using synthetic outcomes"
    label: "Performance"
---
