...
gallery:
  - src: "/projects/screenshots/cocare-calendar.png"
    alt: "CoCare monthly care calendar using synthetic family data"
    label: "Care calendar"
  - src: "/projects/screenshots/cocare-requests.png"
    alt: "CoCare structured schedule change request using synthetic data"
    label: "Change requests"
    fit: "contain"
  - src: "/projects/screenshots/cocare-mobile.png"
    alt: "CoCare responsive mobile calendar using synthetic family data"
    label: "Mobile view"
    fit: "contain"
---
