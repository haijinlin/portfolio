...
gallery:
  - src: "/projects/screenshots/remindflow-dashboard.png"
    alt: "RemindFlow dashboard populated with synthetic reminders and no personal records"
    label: "Dashboard"
  - src: "/projects/screenshots/remindflow-calendar.png"
    alt: "RemindFlow calendar showing fictional life admin tasks"
    label: "Calendar"
  - src: "/projects/screenshots/remindflow-mobile.png"
    alt: "Responsive RemindFlow dashboard using synthetic reminder data"
