...
gallery:
  - src: "/projects/screenshots/wishtree-board.png"
    alt: "WishTree family wish board using synthetic child-friendly data"
    label: "Wish board"
  - src: "/projects/screenshots/wishtree-granted.png"
    alt: "WishTree granted-wish filter using synthetic data"
    label: "Granted wishes"
  - src: "/projects/screenshots/wishtree-manage.png"
    alt: "WishTree parent management controls using synthetic data"
